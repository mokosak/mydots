...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=14", "JetBrainsMono Nerd Font:size=14" };
...
//Top bar second color (blue) and active window border color ORANGE=="#f59542"
